...
use nalgebra::{
    ...
    ClosedAdd, ClosedMul, DefaultAllocator, Dim, Matrix, OMatrix, Scalar, Storage,
};

impl<N, R1, R2, C1, C2, S1, S2> FPDot<Matrix<N, R2, C2, S2>, N> for Matrix<N, R1, C1, S1>
where
    ...
    ShapeConstraint: DimEq<R1, R2> + DimEq<C1, C2>,
{
    ...
    fn dot(&self, other: &Matrix<N, R2, C2, S2>) -> N {
        self.dot(other)
    }
}

impl<N, R, C, S> FPDot<N, OMatrix<N, R, C>> for Matrix<N, R, C, S>
where
    N: Scalar + ClosedMul + Copy,
    R: Dim,
    C: Dim,
    S: Storage<N, R, C>,
...
impl<N, R, C, S> FPDot<Matrix<N, R, C, S>, OMatrix<N, R, C>> for N
where
    N: Scalar + ClosedMul + Copy,
    R: Dim,
    C: Dim,
...
//impl<N, R1, R2, C1, C2, SA, SB> FPDot<Matrix<N, R2, C2, SB>, OMatrix<N, R1, C2>>
...
//                    let res: $t = <Vector3<$t> as FPDot<Vector3<$t>, $t>>::dot(&a, &b);
...
//                        <Vector3<$t> as FPDot<$t, Vector3<$t>>>::dot(&a, &b);
...
//                    let b = 2 as $t;
//                    let product: Vector3<$t> =
//                        <$t as FPDot<Vector3<$t>, Vector3<$t>>>::dot(&b, &a);
//                    let res = Vector3::new(2 as $t, 4 as $t, 6 as $t);
//                    for i in 0..3 {
//                        assert!((((res[i] - product[i]) as f64).abs()) < std::f64::EPSILON);
//                    }
...
//                        <Vector3<$t> as FPDot<RowVector3<$t>, Matrix3<$t>>>::dot(&a, &b);
//                    for i in 0..3 {
//                        for j in 0..3 {
...
//                    let product: Vector3<$t> =
//                        <Matrix3<$t> as FPDot<Vector3<$t>, Vector3<$t>>>::dot(&a, &b);
//                    for i in 0..3 {
//                        assert!((((res[i] - product[i]) as f64).abs()) < std::f64::EPSILON);
//                    }
//                }
...
//                    );
//                    let product: Matrix3<$t> =
//                        <Matrix3<$t> as FPDot<Matrix3<$t>, Matrix3<$t>>>::dot(&a, &b);
//                    for i in 0..3 {
//                        for j in 0..3 {
//                            assert!((((res[(i, j)] - product[(i, j)]) as f64).abs()) < std::f64::EPSILON);
//                        }
...
//                    );
//                    let product: Matrix3<$t> =
//                        <Matrix3<$t> as FPDot<$t, Matrix3<$t>>>::dot(&a, &(2 as $t));
//                    for i in 0..3 {
//                        for j in 0..3 {
//                            assert!((((res[(i, j)] - product[(i, j)]) as f64).abs()) < std::f64::EPSILON);
//                        }
...
//                    );
//                    let product: Matrix3<$t> =
//                        <$t as FPDot<Matrix3<$t>, Matrix3<$t>>>::dot(&(2 as $t), &a);
//                    for i in 0..3 {
//                        for j in 0..3 {
//                            assert!((((res[(i, j)] - product[(i, j)]) as f64).abs()) < std::f64::EPSILON);
//                        }
